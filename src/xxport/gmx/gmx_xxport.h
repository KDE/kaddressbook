...
public:
    ...
    bool exportContacts(const KAddressBookImportExport::KAddressBookImportExportContactList &list, VCardExportSelectionWidget::ExportFields) const Q_DECL_OVERRIDE;
